class Sorter { //<>//
  ...
  String sortDisp = "bar";
  String sortStyle = "cocktail";
  int arrayAccess = 0;
  int comparisons = 0;
  float angleRatio;
  int correct; // number of correct numbers in order
  int start = 0; //start of unsorted
  int end; //end of unsorted
  int currentPlace = 0;
  int solved;
